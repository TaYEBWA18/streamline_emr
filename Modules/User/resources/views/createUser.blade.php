...
<div class="container">
  ...
  @csrf
  <div class="image">
  <img src="{{ asset('https://streamlinehealth.org/wp-content/uploads/2023/08/logo-02.webp') }}" alt="Stre@mline Hospital Logo"><h2 style="text-align: center; color: green;">Hospital</h2><br>
    <h4>REGISTER HERE </h4>
</div>
    <div class="row">
      <h4>Account</h4>
      ...
      <select  name="role" id="role" class="" placeholder="" >
                     ...
                     <option value="3" @if(old('role')=='3') selected @endif>Lab Supervisor</option>
                     <option value="4" @if(old('role')=='4') selected @endif>Lab Assistant</option>
                     <option value="5" @if(old('role')=='5') selected @endif>Pharmacist</option>
                     <option value="6"@selected(old('role')=='6')>Nurse</option>
                     <option value="7" @if(old('role')=='7') selected @endif>Receptionist</option>
                </select>
    ...
    <div class="row">
      ...
      <div><button type="submit"><b>Submit</b></button><br><br> Already have an account ? <br><br><a href="{{route('loginPage')}}"><b>Log in</b></a></div>
    </div>
